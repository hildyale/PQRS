...
import co.edu.udea.iw.Exception.BLException;
import co.edu.udea.iw.Exception.MyDaoException;
import co.edu.udea.iw.bl.EmployeeBL;
import co.edu.udea.iw.bl.ReportBL;
import co.edu.udea.iw.bl.UserBL;
import co.edu.udea.iw.dto.Employee;
import co.edu.udea.iw.dto.Report;
import co.edu.udea.iw.dto.ReportType;
import co.edu.udea.iw.dto.ReportWs;
...
public class ServicioReport {
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Path("listarUser")
	public List<ReportWs> obtenerReportesPendientes(@QueryParam("user") String idUser) throws MyDaoException, BLException{
