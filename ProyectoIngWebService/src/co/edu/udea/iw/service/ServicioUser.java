...
import co.edu.udea.iw.dto.UserWs;
...
public class ServicioUser {
	...
	@Path("actualizar")
	public String actualizarEmpleado(@QueryParam("id") String cedula,@QueryParam("name") String name,@QueryParam("lastname") String lastname,@QueryParam("city") String city,@QueryParam("phone") String phone,
